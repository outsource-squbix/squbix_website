...
<nav class="topnav navbar-expand-lg" id="tp_nav">
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	<div class="navbar-nav" id="nav_top">
      <a id="nav_top2" class="nav-item nav-link"><span><img style={{marginRight:'5px'}} class="nav_img" src="/images/singapore.png" 
      alt="singapore" /></span>  SINGAPORE <span style={{marginLeft:'10px', marginRight:'15px'}}>|</span> 
      <span><img style={{marginRight:'5px'}} class="nav_img" src="/images/india.png" 
      alt="singapore" /></span>  BENGALURU | BHUBANESWAR</a>
...
<div className="navbar-text">
 <div className="col">
	  ...
	  <div className="col">
		<small className="logo_text">A SWNGlobal Blockchain Service</small>
	  </div>
 </div>
</NavLink> 
			</div>
...
<NavLink data-toggle="collapse" data-target="#navbarSupportedContent" data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/about'>About</NavLink>
		   {/* <NavLink className="dropdown-item" to='/education'>Training And Education</NavLink> */}
		   <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/career'>Career</NavLink>
		   <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/contact'>Contact</NavLink>
        </div>
</li>
...
{/* <NavLink className="dropdown-item" to='/Blockchain/polkadot'>Polkadot</NavLink>
        ...
        <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/ico_ieo'>ICO, IEO</NavLink>
        <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/smartcontract'>Smart Contract Developement</NavLink>
        {/* <NavLink className="dropdown-item" to='/defi'>Defi solution</NavLink> */}
        <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/nft'>NFT / DeFI</NavLink>
        <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/dapps'>dApps Development</NavLink>
        {/* <NavLink className="dropdown-item" to='/b_consulting'> Blockchain Consulting</NavLink> */}

        </div>
</li>

<li className="nav-item"><NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="nav-link" to='/crypto_wallet'>DIGITAL WALLET</NavLink></li>
...
<div class="dropdown-menu" aria-labelledby="navbarDropdown">
             ...
             <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/dex'>DEX / CE</NavLink>
              <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/dse'>DSE - Digital Stock Exchange</NavLink>
...
<NavLink class="nav-link dropdown-toggle" id="navbarDropdown" 
role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" 
to='/'>OTHER SERVICES</NavLink>
<div class="dropdown-menu" aria-labelledby="navbarDropdown">

        <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/web_mobile_development'>WEB & Mobile Development</NavLink>
        <NavLink data-toggle="collapse" data-target="#navbarSupportedContent" className="dropdown-item" to='/digital_marketing'>Digital Marketing</NavLink>
